package edu.neu.madcourse.mayankranjandayal.communication;
...
//        getActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    {
        Intent intent = new Intent(this, edu.neu.madcourse.mayankranjandayal.communication.two_player.CommunicationMain.class);
        this.startActivity(intent);
    }

    public void startSinglePlayer(View view)
    {
        Intent intent = new Intent(this, edu.neu.madcourse.mayankranjandayal.communication.single_player.single_player_home.class);
        this.startActivity(intent);
    }
