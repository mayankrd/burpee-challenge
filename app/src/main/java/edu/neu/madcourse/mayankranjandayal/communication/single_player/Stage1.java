...
import edu.neu.madcourse.mayankranjandayal.scraggle.DataHolder;
import edu.neu.madcourse.mayankranjandayal.scraggle.RemoteClient;
import edu.neu.madcourse.mayankranjandayal.scraggle.ScraggleHome;
import edu.neu.madcourse.mayankranjandayal.scraggle.Stage2;
...
public class Stage1 extends Activity {
    ...
    edu.neu.madcourse.mayankranjandayal.scraggle.RemoteClient remote;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.comm_scraggle_activity_stage1_1p);
        //loading data into tiles
        this.loadData();
    ...
    public void showHome(View view){
        ...
        Intent intent = new Intent(this, ScraggleHome.class);
        startActivity(intent);
    ...
    public void stage1CountdownTimer(long duration, final Activity obj)
    {
        ...
        tmr = new CountDownTimer(duration, 1000) {
            ...
            public void onFinish() {
                ...
                mMediaPlayer.reset();
                mMediaPlayer.release();
                Intent intent = new Intent(obj, Stage2.class);
                startActivity(intent);
                finish();
            }
        }.start();
