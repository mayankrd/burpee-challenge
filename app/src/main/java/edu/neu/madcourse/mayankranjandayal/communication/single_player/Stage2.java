...
/*    *//**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.scraggle_activity_stage2);
        //getActionBar().setDisplayHomeAsUpEnabled(true);
        this.loadData();
        if(edu.neu.madcourse.mayankranjandayal.communication.single_player.DataHolder.getInstance().isContinueButtonClicked())
        {
        ...
        smallPos.add(99);
        largePos.add(99);
        bonusPoints = edu.neu.madcourse.mayankranjandayal.communication.single_player.DataHolder.getInstance().getBonusPoints();
        points = edu.neu.madcourse.mayankranjandayal.communication.single_player.DataHolder.getInstance().getPoints();
        ...
        fillStage2Tiles(edu.neu.madcourse.mayankranjandayal.communication.single_player.DataHolder.getInstance().getWords(), edu.neu.madcourse.mayankranjandayal.communication.single_player.DataHolder.getInstance().getCorrectClicks(), points, stage2LetterClicked);
...
/*        // ATTENTION: This was auto-generated to implement the App Indexing API.
    ...
    {
        edu.neu.madcourse.mayankranjandayal.communication.single_player.DataHolder.getInstance().setStage2LetterClicked(stage2LetterClicked);
        edu.neu.madcourse.mayankranjandayal.communication.single_player.DataHolder.getInstance().setInputWordStage2(inputWord);
        edu.neu.madcourse.mayankranjandayal.communication.single_player.DataHolder.getInstance().setStage2TimerDuration(miliSecsLeft);
    }

    public void restoreGame()
    {
        stage2LetterClicked = edu.neu.madcourse.mayankranjandayal.communication.single_player.DataHolder.getInstance().getStage2LetterClicked();
        inputWord = edu.neu.madcourse.mayankranjandayal.communication.single_player.DataHolder.getInstance().getInputWordStage2();
        timerDuration = edu.neu.madcourse.mayankranjandayal.communication.single_player.DataHolder.getInstance().getStage2TimerDuration();
    ...
    public void restartGame(View view) {
        ...
        Intent intent = new Intent(this, edu.neu.madcourse.mayankranjandayal.communication.single_player.Stage1.class);
    ...
    public void showHome(View view) {
        ...
        saveGame();
        edu.neu.madcourse.mayankranjandayal.communication.single_player.DataHolder.getInstance().setContinueFlagStage2(true);
        mMediaPlayer.stop();
        mMediaPlayer.reset();
        mMediaPlayer.release();
        lst_ab= null;
        ...
        finish();
        tmr.cancel();
        Intent intent = new Intent(this, home_1p.class);
        startActivity(intent);
    }
    ...
    public void goToSummary() {
        ...
        mMediaPlayer.reset();
        mMediaPlayer.release();
        edu.neu.madcourse.mayankranjandayal.communication.single_player.DataHolder.getInstance().setPoints(points);
        edu.neu.madcourse.mayankranjandayal.communication.single_player.DataHolder.getInstance().setBonusPoints(bonusPoints);
        tmr.cancel();
        Intent intent = new Intent(this, edu.neu.madcourse.mayankranjandayal.communication.single_player.Summary.class);
        startActivity(intent);
        finish();
    }
...
/*    @Override
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://edu.neu.madcourse.mayankranjandayal.scraggle/http/host/path")
        );
