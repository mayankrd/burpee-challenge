...
import edu.neu.madcourse.mayankranjandayal.finalProject.BurpeeScreenZero;
...
public class MainActivity extends Activity {
    ...
    {
        Intent intent = new Intent(this, edu.neu.madcourse.mayankranjandayal.communication.Communication.class);
        startActivity(intent);
